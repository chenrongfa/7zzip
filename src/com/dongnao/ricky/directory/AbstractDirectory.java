  ...
  implements Directory
{
  ...
  public Set<String> getFiles(boolean recursive)
  {
    ...
    Iterator localIterator1 = getAbstractDirs().entrySet().iterator(); while (localIterator1.hasNext()) { Map.Entry dir = (Map.Entry)localIterator1.next();
  ...
  public Directory getDir(String path) throws com.dongnao.ricky.directory.PathNotExist
  {
    SubPath subpath = getSubPath(path);
    if (subpath.dir != null)
    ...
    if (!(getAbstractDirs().containsKey(subpath.path)))
      throw new com.dongnao.ricky.directory.PathNotExist(path);
  ...
  protected Map<String, AbstractDirectory> getAbstractDirs(boolean recursive) {
    ...
    Iterator localIterator1 = getAbstractDirs().entrySet().iterator(); while (localIterator1.hasNext()) { Map.Entry dir = (Map.Entry)localIterator1.next();
      ...
      while (localIterator2.hasNext()) {
        Map.Entry subdir = (Map.Entry)localIterator2.next();
  ...
  private SubPath getSubPath(String path) throws com.dongnao.ricky.directory.PathNotExist {
    ParsedPath parsed = parsePath(path);
    if (parsed.dir == null)
